...
public class CodingUtils {
	...
	public static String encodeURLGBK(String arg) throws Exception{		
		String content = URLEncoder.encode(arg,"GBK");
		return content;
	}
	
	public static String decodeURLGBK(String arg)throws Exception{
		String content = URLDecoder.decode(arg,"GBK");
		return content;
	}
