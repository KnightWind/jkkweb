...
@Controller
public class StaffCommentSVController extends BaseController{
	public final String prefix="/staff_comment_";
	...
	public Map<String,Object> detail(HttpServletRequest request) throws Exception {
		...
		String json=request.getParameter("json");try {
			if(StringUtils.isBlank(json)){
				...
				VStaffComment bean=dao.getBeanById(Integer.parseInt(id.trim()));
