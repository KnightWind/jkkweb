...
import com.jkkp.client.alipay.sign.RSA;
...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params, String type) {
	    ...
	    boolean isSign = getSignVeryfy(params, sign, type);

        //写日志记录（若要调试，请取消下面两行注释）
        String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n 返回回来的参数：" + AlipayCore.createLinkString(params);
        System.out.println(String.format("<<<  sWord:%s >>>", sWord));
    ...
    */
    private static String checkUrl(String urlvalue) {
        ...
        try {
            ...
            System.out.println(String.format("<<<   checkUrl:%s   >>>", inputLine));
        } catch (Exception e) {
            e.printStackTrace();
            inputLine = "";
        }
