...
<script type="text/javascript">
	function checkLogin(){ 
		...
		$("#j_username").val('FOREMAN_PREFIX_'+username);
		return true;
	}
</script>
</head>
...
<div class="login">
	<div class="login_bg">
    	<div class="login_box">
			<form id="form1" name="form1" method="post" action="/jtxweb/admin/j_security_check" onsubmit="checkLogin();">
