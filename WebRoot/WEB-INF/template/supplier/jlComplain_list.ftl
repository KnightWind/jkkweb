		 ...
		 <div class="tools white border mb10 sp10 clr">
				...
				<ul>					
					<li>
						...
						<span class="sp"><strong class="auto">监理：</strong><input type="text" class="text" name="snickName" id=""></span>
					</li>					
					<li>
						<strong>状态：</strong>
					    <span class="sp radio">
			...
			<div class="page_tab_box">
                <div class="page_tab">
                    <div class="pageTab">
                        <span class="cur"><a href="${base}/jlComplain/index.xhtml?pid=${pid}&mid=${mid}">全部</a></span>
                        <span ><a href="${base}/jlComplain/index.xhtml?pid=${pid}&mid=${mid}&type=2">监理投诉业主</a></span>
                        <span ><a href="${base}/jlComplain/index.xhtml?pid=${pid}&mid=${mid}&type=1">业主投诉监理</a></span>                                              
                    </div>
                </div>
            </div>
					...
					<tr>						
						...
						<td>
							...
							[#else]			
							    ...
							    <span class="btn del" rel="${base}/jlComplain/close.do?id=${item.id}">关闭</span>
							[/#if]
                        </td>
					</tr>
					[/#list]
...
<%for(i=0;i<result.elements.length;i++){%>
	<tr>
		...
		<% if(result.elements[i].status==2){%>
			...
			<span class="btn del" rel="${base}/jlComplain/close.do?id=<%=result.elements[i].id%>">关闭</span>
		<%}%>  
		</td>
	</tr>
<%}%>
