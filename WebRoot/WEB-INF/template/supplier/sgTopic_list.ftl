		...
		<div class="conBox">
		 <div class="tools white border mb10 sp10 clr">
			...
			<div class="page_tab_box">
                <div class="page_tab">
                    <div class="pageTab">
                        <span class="cur"><a href="${base}/sgtopic/index.xhtml?pid=${pid}&mid=${mid}">全部</a></span>
                        <span ><a href="${base}/sgtopic/index.xhtml?pid=${pid}&mid=${mid}&status=0">未审核</a></span>
                        <span ><a href="${base}/sgtopic/index.xhtml?pid=${pid}&mid=${mid}&status=1">通过</a></span>     
                        <span ><a href="${base}/sgtopic/index.xhtml?pid=${pid}&mid=${mid}&status=-1">未通过</a></span>                                          
                    </div>
                </div>
            </div>
...
$(function(){
	$('.ui-paging').page({
		url:'${base}/sgtopic/pagination.do',
