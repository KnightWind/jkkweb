	...
	<!-- header -->
		...
		<div class="conBox">
			<!--内容放这里 start-->
                ...
                <div class="page_tab">
                    <div class="pageTab">
                        <span class="cur"><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}">全部</a></span>
                        <span ><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}&status=10">待开工</a></span>
                        <span ><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}&status=20">开工</a></span>
                        <span ><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}&status=30">水电</a></span>
                        <span ><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}&status=40">瓦木</a></span>
                        <span ><a href="${base}/engineerings/indexSU.xhtml?pid=${pid}&mid=${mid}&status=50">竣工</a></span>                                          
                    </div>
                </div>
            </div>
			...
			<table class="format">
				...
				<tbody>
					...
					<tr>
						...
						<td>${item.creauser}</td>	
						<td>
						 <span class="btn"><a href="detail.xhtml?id=${item.id}&req=engineeringsSU_detail">详情</a></span>
						</td>		           
					</tr>
					[/#list]
				</tbody>
