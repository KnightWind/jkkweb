				  	...
				  	<table class="format">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a class="obtn send" href='${base}/admin/settlement/settlementByPhone.xhtml?phone=${item.rphone}&role=0&mid=${mid}&pid=${pid}'>去结算</a>
								</td>	
							</tr>
							[/#list]
						</tbody>
...
<%for(i=0;i<result.elements.length;i++){%>
	<tr>
		...
		<td>
			<a class="obtn send" href='${base}/admin/settlement/settlementByPhone.xhtml?phone=<%=result.elements[i].rphone%>&role=0&mid=${mid}&pid=${pid}'>去结算</a>
		</td>	
    </tr>	
<%}%>
