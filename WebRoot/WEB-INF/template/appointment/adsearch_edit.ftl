...
<div class="wrap index bc clr">
	<div class="conWrap fl">
		...
		<div class="conBox">
			...
			[#list pagination.dataList as view]
				<form id="send">
				<input type="hidden" name="id" value="${view.id}">
				<input type="hidden" name="status" value="${view.status}">
				<ul>
					<li><strong><b class="red">*</b> 广告名称：</strong> <input type="text" name="name" value="${view.name}" placeholder="广告名称"></li>
					<li><strong><b class="red">*</b> 关键词：</strong> <textarea name="aname" value="${view.aname}"></textarea></li>
					<li><strong><b class="red">*</b> 广告图片：<img src="${view.pid}" name="pid" /></strong><input type="file" name="pid" /></li>
					<li><div style="clear: both;"></div></li>
					<li>
						<strong><b class="red">*</b> 广告地址：</strong> <input type="text" value="${view.url}" name="url"  placeholder="广告地址">
					</li>
				</ul>
				<span class="buttons">
