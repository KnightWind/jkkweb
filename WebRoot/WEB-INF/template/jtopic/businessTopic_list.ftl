		 ...
		 <div class="tools white border mb10 sp10 clr">
				...
				<li>
					...
					<li>
						<span class="sp">
						   <strong >商家：</strong>
						   <input type="text" class="text" name="spName" id="">
					   </span>
					</li>										
					<li>
			...
			<div class="page_tab_box">
                <div class="page_tab">
                    <div class="pageTab">
                        <span class="cur"><a href="${base}/jtopic/index.xhtml?pid=${pid}&mid=${mid}">全部</a></span>
                        <span ><a href="${base}/jtopic/index.xhtml?pid=${pid}&mid=${mid}&status=0">未审核</a></span>
                        <span ><a href="${base}/jtopic/index.xhtml?pid=${pid}&mid=${mid}&status=1">通过</a></span>     
                        <span ><a href="${base}/jtopic/index.xhtml?pid=${pid}&mid=${mid}&status=-1">未通过</a></span>                                          
                    </div>
                </div>
            </div>
			...
			<table class="format">
				...
				<tbody>
					...
					<tr>			
						...
						<td>
							<span class="btn"><a href="detail.xhtml?pid=${pid}&mid=${mid}&id=${item.id}&tid=${item.id}">审核</a></span>				
                        </td>
					</tr>
					[/#list]
				</tbody>
...
<%for(i=0;i<result.elements.length;i++){%>
	<tr>
		...
		<td>		
		   <span class="btn"><a href="detail.xhtml?pid=${pid}&mid=${mid}&id=<%=result.elements[i].id%>&tid=<%=result.elements[i].id%>">审核</a></span>						
		</td>
	</tr>
<%}%>
</script>
...
$(function(){
	$('.ui-paging').page({
		url:'${base}/jtopic/BTPagination.do',
