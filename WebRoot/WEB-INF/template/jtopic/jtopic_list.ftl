		...
		<table class="format">
				...
				<tbody>
					...
					<tr>			
						...
						<td>
							<span class="btn"><a  href="${base}/jtopic/view.xhtml?id=${item.id}&mid=${mid}&pid=${pid}">审核</a>	</span>				
                        </td>
					</tr>
					[/#list]
				</tbody>
...
<%for(i=0;i<result.elements.length;i++){%>
	<tr>
		...
		<td>		
		   <span class="btn"><a href="${base}/jtopic/view.xhtml?id=<%=result.elements[i].id%>&mid=${mid}&pid=${pid}">审核</a></span>						
		</td>
	</tr>
<%}%>
</script>
