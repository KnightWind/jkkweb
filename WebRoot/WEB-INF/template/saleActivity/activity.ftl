	...
	<div class="conWrap fl">
		[#include "/common/nav.ftl"]
			...
			<div class="tools white border mb10 sp10 clr">
				...
				<ul>
					<li>
						<span class="sp"><strong>报名时间：</strong><input type="text" class="text Wdate" name="start" id="start" onClick="WdatePicker()" readOnly></span>
...
$(function(){
	$("#daochu").click(function(){
	  var start=$("#start").val();
	  var end=$("#end").val();
		 location.href ='${base}/wxActivityJionSign/daochu.do?start='+start+'&end='+end;
