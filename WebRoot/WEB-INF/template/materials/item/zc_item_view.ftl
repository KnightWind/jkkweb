...
<div class="wrap index bc clr">
	...
	<div class="oper">
		<form id="form" method="post" action="${base}/materials/item/oper.xhtml?id=${item.id}&mid=${mid}&pid=${pid}">
			【${item.title}】正在申请设置为众筹商品<br/>是否通过审核:<input type="radio" checked="checked" name="op" value="1" />是  &nbsp;&nbsp;<input type="radio" name="op" value="-1" />否&nbsp;&nbsp;
