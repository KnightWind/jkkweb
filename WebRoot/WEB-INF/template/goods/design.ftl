		...
		<div class="tools white border mb10 sp10 clr">
				...
				<ul>
					...
					<li>
						...
						<span class="sp"><strong>效果图名：</strong><input type="text" class="text" name="name" id=""></span>
					</li>
					<li>
			...
			<table class="format">
				...
				<tbody>
					...
					<tr>
						...
						<td>${item.cre}</td>									
						<td>				
						<a class="obtn" href="${base}/design/xg/bn.xhtml?mid=${mid}&pid=${pid}&id=${item.id}&did=${did}&city=${city}">选择</a>	
						</td>
					</tr>
					[/#list]
				</tbody>
...
<%for(i=0;i<result.elements.length;i++){%>
	...
	<td>
		<a class="obtn" href="${base}/design/xg/bn.xhtml?mid=${mid}&pid=${pid}&id=<%=result.elements[i].id%>&did=${did}&city=${city}">选择</a>
	</td>
</tr>
<%}%>
</script>
...
$(function(){
	$('.ui-paging').page({
		url:'${base}/goods/design/pagination.do?mid=${mid}&pid=${pid}',
		deal:{'click':'.search'},		
		send:function(){
			var data={
					pageSize:10,
