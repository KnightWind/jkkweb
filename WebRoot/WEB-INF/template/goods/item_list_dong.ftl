				...
				<ul>
					...
					<li>
						...
						<div class="select">
							<i class="new">&#xf107;</i><span>--请选择--</span>
							<p>
								<a href="javascript:;" value="huadong">华东</a>
								<a href="javascript:;" value="huanan">华南</a>
								<a href="javascript:;" value="zhongnan">中南</a>
								<a href="javascript:;" value="dongbei">东北</a>
								<a href="javascript:;" value="xinan">西南</a>
								<a href="javascript:;" value="huabei">华北</a>
								<a href="javascript:;" value="xibei">西北</a>
								<a href="javascript:;" value="gangaotai">港澳台</a>
							</p>
						</div>
					...
					<li>
						<span class="sp radio"><strong>商品状态：</strong><input type="radio" name="status" id="status"><label for="status"> 全部 </label><input type="radio" name="status" id="status1"><label for="status1"> 上架 </label><input type="radio" name="status" id="status2"><label for="status2"> 下架 </label></span>
						<span class="sp radio"><strong>0 元 购：</strong><input type="radio" name="status1" id="status3"><label for="status3"> 全部 </label><input type="radio" name="status1" id="status4"><label for="status4"> 参与 </label><input type="radio" name="status1" id="status5"><label for="status5"> 不参与 </label></span>
					</li>
				</ul>
				</form>
			</div>
