	...
	<div class="conWrap fl">
		...
		<div class="conBox">
			<div class="ui-dialog addManager" style="width:100%;">
				...
				<div>
					<label style="float:left;width:10%;text-align:right;">券批次：</label>
					<span style="margin-left:4px;"><input id="no" name="no" value=""></span>
				</div>
				<div style="margin-top:10px;">
					<label style="float:left;width:10%;text-align:right;">实际面值：</label>
					<span style="margin-left:4px;"><input id="parValue" name="parValue" value=""></span>
				</div>
				<div style="margin-top:10px;">
					<label style="float:left;width:10%;text-align:right;">有效期限：</label>
					<span style="margin-left:4px;"><input id="expireStart" name="expireStart" value=""></span>
					<label style="margin-left:8px;margin-right:8px">-</label>
					<span><input id="expireEnd" name="expireEnd" value=""></span>
				</div>
				<div style="margin-top:10px;">
					<label style="float:left;width:10%;text-align:right;">预发总数：</label>
					<span style="margin-left:4px;"><input id="num" name="num" value=""></span>
				</div>
				<div style="margin-top:10px;margin-bottom:20px;">
					<label style="float:left;width:10%;text-align:right;">&nbsp;</label>
					<span style="margin-left:4px;">
						<span class="btn saveBtn">保存</span>&nbsp;
						<a href="${base}/quanCard/index.xhtml?mid=${mid}&pid=${pid}"><span class="btn">返回</span></a>
					</span>
				</div>
				</form>
			</div>
